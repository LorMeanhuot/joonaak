...
class DeliveryAssignedCard extends StatelessWidget {
  final DeliveryItemModel itemModel;
  final Widget payment;
  final Function onGoing;
  final Widget price;

  const DeliveryAssignedCard({Key key, this.itemModel, this.payment, this.onGoing, this.price}) : super(key: key);
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => new DeliveryDetailPage(
                      ...
                      payment: payment,
                      delivery: itemModel,
                      backGroundColor1: AppColor.PENDING_COLOR,
                      backGroundColor2: AppColor.yellowLight,
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                    ...
                    colors: [AppColor.yellowLight, AppColor.PENDING_COLOR]),
                boxShadow: [
                  BoxShadow(
                    color: Colors.grey.withOpacity(0.3),
                    spreadRadius: 5,
                                    ...
                                    RichText(
                                      ...
                                      text: TextSpan(
                                          ...
                                          children: [
                                            TextSpan(
                                                text:
                                                '${itemModel.note == null || itemModel.note == "" ? "N/A" : itemModel.note}',
                                                style: TextStyle(
                                                    fontSize: 12,
                                                    fontWeight: FontWeight.w300)),
                                          ]),
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(TranslatorUtil.text("today"),
                                style: TextStyle(
                                    fontSize: 10,
                                    fontWeight: FontWeight.bold,
