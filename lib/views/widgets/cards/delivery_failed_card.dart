...
class DeliveryFailedCard extends StatelessWidget {

  final DeliveryItemModel itemModel;
  final Widget payment;
  final Widget price;

  const DeliveryFailedCard(
        ...
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) => new DeliveryDetailPage(
                      ...
                      payment: payment,
                      delivery: itemModel,
                      backGroundColor1: AppColor.red,
                      backGroundColor2: AppColor.redLight,
                      title: TranslatorUtil.text('failToDelivery'),
                    )));
      },
      child: Container(
        height: 120,
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
              ...
              colors: [AppColor.redLight, AppColor.red]),
          boxShadow: [
            BoxShadow(
